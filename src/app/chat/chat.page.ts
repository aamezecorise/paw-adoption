...
import { ModalController, PopoverController, LoadingController, MenuController, NavParams, Platform, ToastController, IonContent, ActionSheetController} from '@ionic/angular';
...
export class ChatPage implements OnInit, AfterViewInit{
  ...
  ngOnInit() {
    ...
    this.receiverId = this.userDetails.userId;
    this.receiverName = this.userDetails.fullName;
    console.log(this.receiverId,this.receiverName);
    console.log(this.userDetails,this.userData,this.senderImage);
   ...
   ngAfterViewInit(){
	...
	this.apiService.getUserById(this.receiverId).subscribe(res => {
  	...
  	this.apiService.GetAllMessages(senderId,receiverId).subscribe(res => {
	    ...
	    this.messages = res.json().result.message;
        this.isLoading = false;
